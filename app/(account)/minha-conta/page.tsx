...
export default async function AccountOverviewPage() {
  ...
  const stats = [
    { label: "Pedidos", value: orderCount, icon: Package, href: "/minha-conta/pedidos" },
    { label: "Endereços", value: addressCount, icon: MapPin, href: "/minha-conta/enderecos" },
    { label: "Favoritos", value: favoriteCount, icon: Heart, href: "/minha-conta/favoritos" },
    { label: "Avaliações", value: reviewCount, icon: Star, href: "/minha-conta/avaliacoes" },
  ];
