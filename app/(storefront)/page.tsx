...
export default async function HomePage() {
  ...
  return (
    <div className="pb-16">
      ...
      {featured.length > 0 && (
        <ProductSection title="Destaques" products={featured} viewAllHref="/produtos?destaque=1" />
      )}

      {onSale.length > 0 && (
        <ProductSection title="Ofertas" products={onSale} viewAllHref="/produtos?promocao=1" badge="OFERTA" />
      )}

      {bestSellers.length > 0 && (
        <ProductSection title="Mais vendidos" products={bestSellers} viewAllHref="/produtos?ordenar=mais_vendidos" />
      )}

      {newArrivals.length > 0 && (
        <ProductSection title="Novidades" products={newArrivals} viewAllHref="/produtos?ordenar=recentes" />
      )}
