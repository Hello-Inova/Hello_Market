...
import { changePlatformEmailAction, type ActionResult } from "@/actions/platform-auth.actions";

const initialState: ActionResult = { success: false };

export function ChangeEmailForm({ currentEmail }: { currentEmail: string }) {
  const router = useRouter();
  const [state, formAction, isPending] = useActionState(changePlatformEmailAction, initialState);
